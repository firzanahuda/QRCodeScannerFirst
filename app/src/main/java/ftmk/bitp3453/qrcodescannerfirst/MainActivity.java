        ...
        if (!scanQR.equals("")){
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    PutData putData = new PutData("http://192.168.8.122/bloodcareapplication/QRCodeDone.php", "POST", field, data);
    ...
    private void fnUpdateStatus(String qrcode, String newQRCode)
    {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                // connect to database
                // (if passed, stop scanning for 5s, else stop scanning for 2 second)
                PutData putData = new PutData("http://192.168.8.122/bloodcareapplication/updateStatus.php", "POST", field, data);
